    ...
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                if(!adminFound) UserWrapper.CreateUser(new User("Jamie", "Stivala", "jamstivala@gmail.com", "Pukka1234!", "77223883", new DateTime(2001, 09, 16, 1, 1, 1), 'M', "0368201L", "Malta", "48 Rhapsody", UserType.Customer));
                UserWrapper.CreateUser(new User("Admin", "Account", "admin@admin.com", "SecurePassword123!", "00000000", new DateTime(2001, 09, 16, 1, 1, 1), 'O', "000000A", "British", "London Bridge", UserType.Admin));
            }
            catch (Exception ex)
            {
                Debug.WriteLine("The default admin user already exists.");
